...
// Categorías válidas
const categoriasValidas = ["Electrónica", "Muebles", "Ropa", "Alimentos", "Libros"];
...
app.post("/productos", (req, res) => {
  ...
  const sql = "INSERT INTO productos (nombre, categoria, cantidad, precio) VALUES (?, ?, ?, ?)";
...
app.patch("/productos/:id/cantidad", (req, res) => {
